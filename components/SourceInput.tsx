...
const SourceInput: React.FC<SourceInputProps> = ({ participants, onUpdate, onNext }) => {
  ...
  // Fixed the error: Operator '>' cannot be applied to types 'unknown' and 'number'.
  // Using explicit type (any) for the filter parameter because Array.from might infer unknown in some environments.
